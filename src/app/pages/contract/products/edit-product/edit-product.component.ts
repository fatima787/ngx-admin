...
ngOnInit () {
  ...
  stopEdit(): void {
    ...
    this.proService.editPro(this.data.ProductName,this.data.Price,this.data.Quantity,this.data.status,
      this.data.startdate,this.data.enddate,this.data.priceterm,this.data.term,
      this.data.totalprice,this.start,this.end, this.data.id);
  }
  startDateClicked() {
